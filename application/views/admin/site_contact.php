...
<div>
    ...
    <div class="panel-body">
        <form role="form"  method="post" class="form-horizontal form-groups-bordered validate" novalidate="novalidate" enctype="multipart/form-data">
            ...
            <h3> Below Address Detail Section </h3>
            <div class="form-group">
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <div class="col-md-12">
                                ...
                                <input type="text" name="last_heading" value="<?= $row['last_heading'] ?>" class="form-control">
                            </div>
                            <div class="col-md-12">
                                <label for="last_subheading" class="control-label"> Sub Heading <span class="symbol required">*</span></label>
                                <textarea class="form-control" name="last_subheading" rows="4"><?= $row['last_subheading'] ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
